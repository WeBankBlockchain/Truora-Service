...
public class ChainGroupMapUtil {
     ...
     * @return
     */
    public static String getKey(String chainId, String groupId) {
     ...
     */
    public static void put(String chainId, String groupId, String contractAddress, String contractVersion){
     ...
     */
    public static String getVersionWithDefault(String chainId, String groupId, String contractAddress, String defaultVersion){
        String key = getKey(chainId,groupId);
