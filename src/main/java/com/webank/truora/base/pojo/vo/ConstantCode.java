 ...
 */
package com.webank.truora.base.pojo.vo;
...
public class ConstantCode {
    ...
    public static final RetCode NO_CHAIN_SDK_ERROR = RetCode.mark(100001,
            "not sdk for chain");

    public static final RetCode NO_GROUP_CLIENT_ERROR = RetCode.mark(100002,
            "not client for group");
