...
public class SimpleVRFTest extends BaseTest {
    ...
    @Test
    public void testVRFCore() throws Exception {
        ...
        VRFCore vrfCore = VRFCore.deploy(web3j, credentials, ConstantProperties.GAS_PROVIDER).send();
...
//        String blockHash = bytesToHex(CryptoUtil.soliditySha3(blockNumber));
       ...
       // String actualSeedonchain = new String(randomevent.seedAndBlockNum);
        ...
        Thread.sleep(10);
        byte[] proofbyte1= Numeric.hexStringToByteArray(proof);
    ...
    public static List calculateThePK(String skhex) {
