...
@Slf4j
public class APISampleTestV3 extends LocalTestBase {
    ...
    public void testAPISampleLocal() throws Exception {
        ...
        //targetUrl = "plain(https://www.random.org/integers/?num=1&min=1&max=1000&col=1&base=10&format=plain&rnd=new)";
        targetUrl = "json(https://api.exchangerate-api.com/v4/latest/CNY).rates.JPY";
