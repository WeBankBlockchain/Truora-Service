...
contract BAC002 is  IssuerRole, Suspendable {
    ...
    // constructor
    constructor(string memory description, string memory shortName) public
    {
    ...
    function assetOfOwner(address owner) public view returns (uint256[] memory) {
    ...
    function batchSendFrom(address from, address[] memory to, uint256[] memory assetId, bytes memory data) public whenNotSuspended {
    ...
    function destroy(uint256 assetId, bytes calldata data) public {
        //solhint-disable-next-line max-line-length
    ...
    //add issuerAddress
    function issueWithAssetURI(address to, uint256 assetId, string memory assetURI, bytes memory data) public onlyIssuer returns (bool) {
     ...
     */
    function _issue( address to, uint256 assetId, bytes memory data) internal {
     ...
     */
    function _destroy(address owner, uint256 assetId, bytes memory data) internal {
        ...
        emit Send(address(this), owner, address(0), assetId, data);
     ...
     * @dev Internal function to destroy a specific asset.
     */
    function _destroy(uint256 assetId, bytes memory data) internal {
     ...
     */
    function _sendFrom(address from, address to, uint256 assetId, bytes memory data) internal {
